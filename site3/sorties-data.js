(function (window) {
  ...
  const events = [
    ...
    },
    {
      ...
      image: 'assets-premium/event-plan-eau-canada.jpg',
      fallbackImage,
      photoCredit: { commons: 'https://commons.wikimedia.org/wiki/File%3APetit_lac_Plan_d%27eau_du_Canada.JPG', artist: 'Chatsam', license: 'CC BY-SA 3.0' },
    ...
    },
    {
      ...
      image: 'assets-premium/event-olympiades.jpg',
      fallbackImage,
      photoCredit: { commons: 'https://commons.wikimedia.org/wiki/File%3AP%C3%A9tanque_balls_child-20080713-RM-180115.jpg', artist: 'Ermell', license: 'CC BY-SA 4.0' },
      location: 'Beauvais',
