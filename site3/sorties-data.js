  ...
  const outings = [
    {
      ...
      image: 'assets-premium/sortie-deux-caps.jpg',
      fallbackImage,
      photoCredit: { commons: 'https://commons.wikimedia.org/wiki/File%3ACap_Blanc-Nez%2C_view_to_Cap_Gris-Nez.JPG', artist: 'Dguendel', license: 'CC BY 4.0' },
    ...
    },
    {
      ...
      image: 'assets-premium/sortie-baie-somme.jpg',
      fallbackImage,
      photoCredit: { commons: 'https://commons.wikimedia.org/wiki/File%3ABaie_de_Somme_vue_de_Saint-Valery-sur-Somme_%2801%29.jpg', artist: 'JackyM59', license: 'CC BY-SA 4.0' },
    ...
    },
    {
      ...
      image: 'assets-premium/sortie-treport.jpg',
      fallbackImage,
      photoCredit: { commons: 'https://commons.wikimedia.org/wiki/File%3ALe_Tr%C3%A9port.jpg', artist: 'Gzzz', license: 'CC BY-SA 3.0' },
    ...
    },
    {
      ...
      image: 'assets-premium/sortie-dieppe.jpg',
      fallbackImage,
      photoCredit: { commons: 'https://commons.wikimedia.org/wiki/File%3ADieppe_Port_de_Dieppe_05.jpg', artist: 'Zairon', license: 'CC BY-SA 4.0' },
      location: 'Dieppe',
    ...
    },
    {
      ...
      image: 'assets-premium/sortie-giverny.jpg',
      fallbackImage,
      photoCredit: { commons: 'https://commons.wikimedia.org/wiki/File%3AHouse_of_Claude_Monet_%28Giverny%29.jpg', artist: 'Avi1111', license: 'CC BY-SA 4.0' },
      location: 'Giverny',
    ...
    },
    {
      ...
      image: 'assets-premium/sortie-paris.jpg',
      fallbackImage,
      photoCredit: { commons: 'https://commons.wikimedia.org/wiki/File%3ASightseeing_boat%2C_Seine%2C_Paris_26_October_2016.jpg', artist: 'Guilhem Vellut', license: 'CC BY 2.0' },
      location: 'Paris',
    ...
    },
    {
      ...
      image: 'assets-premium/sortie-hortillonnages.jpg',
      fallbackImage,
      photoCredit: { commons: 'https://commons.wikimedia.org/wiki/File%3AVisite_hortillonages_amiens.jpg', artist: 'ByB', license: 'CC BY-SA 3.0' },
    ...
    },
    {
      ...
      image: 'assets-premium/sortie-forges.jpg',
      fallbackImage,
      photoCredit: { commons: 'https://commons.wikimedia.org/wiki/File%3AFor%C3%AAt_d%27Eawy_h%C3%AAtres01.JPG', artist: 'Eponimm', license: 'CC BY-SA 4.0' },
  ...
  const events = [
    {
      ...
      image: 'assets-premium/event-touquet.jpg',
      fallbackImage,
      photoCredit: { commons: 'https://commons.wikimedia.org/wiki/File%3ABateau_%C3%A0_mar%C3%A9e_basse_en_baie_de_Canche_-_Le_Touquet.jpg', artist: 'JackyM59', license: 'CC BY-SA 4.0' },
      location: 'Le Touquet',
    ...
    },
    {
      ...
      image: 'assets-premium/event-plan-eau-canada-hiver.jpg',
      fallbackImage,
      photoCredit: { commons: 'https://commons.wikimedia.org/wiki/File:Plan_d%27eau_du_Canada_en_hiver.jpg', artist: 'Flo.morel.nature', license: 'CC BY-SA 4.0' },
    ...
    },
    {
      ...
      image: 'assets-premium/event-olympiades-petanque.jpg',
      fallbackImage,
      photoCredit: { commons: 'https://commons.wikimedia.org/wiki/File:P%C3%A9tanque_players_in_N%C3%AEmes_03.JPG', artist: 'Palickap', license: 'CC BY-SA 4.0' },
      location: 'Beauvais',
