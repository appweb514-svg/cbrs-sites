...
- Site public vérifiable via `scripts/check-cbrs-ui.mjs` (contrats HTML + `.vercelignore`).
...
| Fuite de fichiers | ~~La racine est publiée : `ROADMAP.md`, PDF, sources accessibles.~~ **Corrigé 2026-09-16** par `.vercelignore` (mémoire, `.hermes/`, `backend/`, docs internes, PDF doublons exclus). | `vercel.json:4`, `.vercelignore` |
